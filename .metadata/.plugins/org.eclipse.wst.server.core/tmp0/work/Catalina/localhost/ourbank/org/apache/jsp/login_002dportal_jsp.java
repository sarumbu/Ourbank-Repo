 ...
 * Generated at: 2017-11-28 00:49:39 UTC
...
public final class login_002dportal_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<head>\r\n");
      out.write("<title>Our Bank || Login-Portal</title>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<h1>Welcome to Secure Login Portal</h1>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"label label-important\">General Guidelines for Login</span> <br> <br>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"alert alert-error\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<h4>User!</h4>\r\n");
      out.write("\t\t\t\t\t\t\t\tIf you are a User then Select \"User\" option From Select Box\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"alert alert-error\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<h4>Employee!</h4>\r\n");
      out.write("\t\t\t\t\t\t\t\tIf you are an Employee then Select \"Employee\" option From Select Box\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"alert alert-error\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<h4>Admin!</h4>\r\n");
      out.write("\t\t\t\t\t\t\t\tIf you are an Admin then Select \"Administrator\" option From Select Box\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<br> <br> <select\r\n");
      out.write("\t\t\t\t\t\t\t\tonchange=\"this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"\">Select...</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"user/login.jsp\">User</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"emp/login.jsp\">Employee</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"admin/login.jsp\">Administrator</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t\t\t<br>\r\n");
